...
tagline: "A desktop app for evaluating stocks through technical and fundamental analysis, powered by on-device ML inference and a local Qwen2.5 1.5B LLM. No cloud, no subscriptions, fully private."
ogDescription: "Desktop app for evaluating stocks through technical and fundamental analysis, powered by on-device ML inference and a local Qwen2.5 LLM. No cloud required."
tags: ["Open Source", "Finance"]
topic: "fin"
tech: ["Tauri v2", "Rust", "React", "TypeScript", "candle (HuggingFace)", "Qwen2.5 1.5B", "Metal / CPU"]
