...
class PortfolioApp {
  ...
  =================================== */
  setupAnimations() {
    this._projects = Array.from(document.querySelectorAll('.project'));
  ...
  animateProjectEntry(projectCard) {
    const index = (this._projects || []).indexOf(projectCard);
    setTimeout(() => {
  ...
  /* ===================================
     RESEARCH PAGES
     Note: sidebar toggle, reading progress, and section tracking
     are handled by main-theme.js. Only section fade-in is here.
  =================================== */
  setupResearchPages() {
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Fade in animation — double rAF ensures the browser commits the opacity:0
  // paint before starting the transition, avoiding a missed frame on fast engines
